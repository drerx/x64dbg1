...
bool IsArgumentsLessThan(int argc, int minimumCount)
{
    ...
    {
        dprintf_html(QT_TRANSLATE_NOOP("DBG", "Not enough arguments! At least %d arguments must be specified. Arguments are <a href=\"https://help.x64dbg.com/en/latest/commands/index.html\">comma-separated</a>."), minimumCount - 1);
        //dprintf(QT_TRANSLATE_NOOP("DBG", "Not enough arguments! At least %d arguments must be specified (comma-separated).\n"), minimumCount - 1);
